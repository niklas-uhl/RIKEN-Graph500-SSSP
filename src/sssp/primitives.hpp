...
struct WeightedEdge {
	...
	void set(int64_t v0, int64_t v1, float weight) {
		set(v0, v1);
		weight_ = weight;
	}
	...
	static void initialize()
	{
		...
		MPI_Datatype types[] = {MPI_UINT32_T, MPI_UINT32_T, MPI_UINT32_T, MPI_FLOAT};
...
template <> struct MpiTypeOf<WeightedOwnerEdge> { static MPI_Datatype type; };
MPI_Datatype MpiTypeOf<WeightedOwnerEdge>::type = MPI_DATATYPE_NULL;
...
struct WeightedOwnerEdge {
   ...
   void set(int64_t v0, int64_t v1, uint16_t owner, float weight) {
      set(v0, v1, weight);
      owner_ = owner;
   }
   ...
   static void initialize()
   {
      int block_length[] = {1, 1, 1, 1, 1};
      MPI_Aint displs[] = {
            reinterpret_cast<MPI_Aint>(&(static_cast<WeightedOwnerEdge*>(NULL)->v0_low_)),
            reinterpret_cast<MPI_Aint>(&(static_cast<WeightedOwnerEdge*>(NULL)->v1_low_)),
            reinterpret_cast<MPI_Aint>(&(static_cast<WeightedOwnerEdge*>(NULL)->high_)),
            reinterpret_cast<MPI_Aint>(&(static_cast<WeightedOwnerEdge*>(NULL)->weight_)),
            reinterpret_cast<MPI_Aint>(&(static_cast<WeightedOwnerEdge*>(NULL)->owner_))};
      MPI_Datatype types[] = {MPI_UINT32_T, MPI_UINT32_T, MPI_UINT32_T, MPI_FLOAT, MPI_UINT16_T};
      MPI_Type_create_struct(5, block_length, displs, types, &MpiTypeOf<WeightedOwnerEdge>::type);
      MPI_Type_commit(&MpiTypeOf<WeightedOwnerEdge>::type);
   }

   static void uninitialize()
   {
      MPI_Type_free(&MpiTypeOf<WeightedOwnerEdge>::type);
   }
};
